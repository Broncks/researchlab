...
def createOutput(resultlist):
    ...
    outWorksheet.write(0, 5, "Total cost (ALNS)")
    outWorksheet.write(0, 6, "Average cost per pod movement (ALNS)")
    ...
    for i in range(len(resultlist)):
        ...
        outWorksheet.write(i + 1, 5, resultlist[i].cost_alns)
        outWorksheet.write(i + 1, 6, resultlist[i].avg_cost_alns)
